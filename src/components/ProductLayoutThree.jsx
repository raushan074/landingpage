...
// Main Component
const ProductLayoutThree = () => {
  const newBornProducts = [
    { title: 'Summer clothes', price: '1100', image: `${sixone}` },
    { title: 'Party wear', price: '1100', image: `${sixtwo}` },
    { title: 'Jumpers', price: '1100', image: `${sixthree}` },
    { title: 'Night suit', price: '1100', image: `${sixfour}` },
    { title: 'Burp clothes', price: '1100', image: `${sixfive}` },
    { title: 'Casual Dress', price: '1100', image: `${sixsix}` },
  ];
...
export default ProductLayoutThree;