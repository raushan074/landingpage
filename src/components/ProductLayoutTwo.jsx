...
const ProductLayoutTwo = () => {
  const newBornProducts = [
    { title: 'Summer clothes', price: '1100', image: `${fiveone}` },
    { title: 'Party wear', price: '1100', image: `${fivetwo}` },
    { title: 'Jumpers', price: '1100', image: `${fivethree}` },
    { title: 'Night suit', price: '1100', image: `${fivefour}` },
    { title: 'Burp clothes', price: '1100', image: `${fivefive}` },
    { title: 'Casual Dress', price: '1100', image: `${fivesix}` },
  ];
